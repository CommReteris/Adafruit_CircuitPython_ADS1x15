...
* Author(s): Lorenzo Seirup; based on the work of Carter Nelson for Adafruit
"""
...
# TODO: right now channel returns a non-human readable value (the adc channel, not the pin). Need to fix that because 
# otherwise the get commands won't sync up with the user *thinks* they are asking


""" Channel definitions (For reference):
